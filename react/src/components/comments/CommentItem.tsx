export default function CommentItem({ comment, setSelectedComment }: { comment: CommentType, setSelectedComment: React.Dispatch<React.SetStateAction<CommentType | null>> }) {
  return (
    <div
